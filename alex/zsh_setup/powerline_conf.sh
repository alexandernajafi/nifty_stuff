...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="alex-theme"
...
# mailcount.sh {
	...
	# export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/alexandernajafi/.mail/inbox/new"
	...
	# export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/alexandernajafi/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/alexandernajafi/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	# export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/Users/alexandernajafi/.tmux/plugins//tmux-continuum"
# }
